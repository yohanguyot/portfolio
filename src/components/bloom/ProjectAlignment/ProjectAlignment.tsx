    ...
    >
      ...
      <div className={styles.body}>
        <p className={styles.paragraph}>
          Les états des composants suivent les pseudo-classes CSS : la structure
          d&apos;un token comme btn-primary-bg-default correspond exactement au code.
        </p>
        <p className={styles.paragraph}>
          La spec technique étant intégrée dans Figma, le développeur implémente
          la maquette sans aucune interprétation. Aucun composant n&apos;est réécrit
          de zéro : l&apos;architecture est autonome.
        </p>
      </div>
    </SplitSection>
  );
